    ...
    homePage.innerHTML = `
        ...
        <div class="card home-card-single">
            ...
            <div class="home-card-buttons">
                <a class="btn site-btn" href="https://x.com/NMSXenoChamp" target="_blank" rel="noopener">Twitter (X)</a><a class="btn site-btn" href="#" target="_blank" rel="noopener">Discord</a>
            </div>
        </div>
    `;
}
