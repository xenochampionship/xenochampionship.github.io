...
function populateHomePage(data, record) {
    ...
    homePage.innerHTML = `
        ...
        <div class="card home-card-single">
            ...
            <div class="home-card-buttons">
                <a class="btn site-btn" href="https://x.com/NMSXenoChamp" target="_blank" rel="noopener"><i class="fas fa-x-twitter"></i> Twitter (X)</a><a class="btn site-btn" href="https://discord.gg/mS25zRggz2" target="_blank" rel="noopener"><i class="fas fa-discord"></i> Discord</a>
            </div>
        </div>
    `;
}
